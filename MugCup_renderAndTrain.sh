...
OBJ=MugCup #tea_bottle
CAD_FILENAME=14_MugCup_green.ply #17_Pet_bottle_pet_tea.obj
...
mkdir -p output/$OBJ
\rm -rf output/$OBJ/*
./render ./input/$CAD_FILENAME output/$OBJ  15 15 10  3  3  36 -1 0 -1 # Rx 15 Ry 10 Rz 0

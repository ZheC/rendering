...
OBJ=DishSoup #DishRice #DishSoup
CAD_FILENAME=19_Dish_bawl_soup.ply #19_Dish_bawl_rice.ply #19_Dish_bawl_soup.ply
...
mkdir -p output/$OBJ
\rm -rf output/$OBJ/*
./render ./input/$CAD_FILENAME output/$OBJ  5 10 10  3  4  1 -1 0 -1 # Rx 15 Ry 10 Rz 0

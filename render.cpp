...
int prev_rot_x, prev_rot_y, prev_rot_z;
...
void renderScene(void) {
  ...
  // set the model in the standing viewpoint
  rotate(90*prev_rot_x, 1.f,0.f,0.f);
  rotate(90*prev_rot_y, 0.f,1.f,0.f);
  rotate(90*prev_rot_z, 0.f,0.f,1.f);
...
int main(int argc, char **argv) {
  ...
  if ( argc < 4 ) {
    ...
    gvar_num_rot_x = atoi( argv[6] );
    gvar_num_rot_y = atoi( argv[7] );
    gvar_num_rot_z = atoi( argv[8] );
    prev_rot_x = atoi( argv[9] );
    prev_rot_y = atoi( argv[10] );
    prev_rot_z = atoi( argv[11] );
  }

...
OBJ=CoffeeCupDot #DishRice #DishSoup
CAD_FILENAME=14_CoffeeCup_dot.ply #19_Dish_bawl_rice.ply #19_Dish_bawl_soup.ply
...
mkdir -p output/$OBJ
\rm -rf output/$OBJ/*
./render ./input/$CAD_FILENAME output/$OBJ  5 15 10  3  3  36 -1 0 -1 # Rx 15 Ry 10 Rz 0
...
\rm -rf ../output/$OBJ/*
\rm -rf ../pre/$OBJ.yml
./train ./input/$OBJ ./output/$OBJ ./pre/$OBJ.yml 324 45
